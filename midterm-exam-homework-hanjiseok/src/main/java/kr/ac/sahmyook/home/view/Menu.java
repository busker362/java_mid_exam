...
public class Menu {
        ...
        do {
            ...
            switch (no) {
                ...
                case 6:
                    is.scoreGrade(); break;
                case 7:
                    is.checkPlusMinusZero(); break;
                case 8:
                    is.whatCaracter(); break;
                case 9:
                    System.out.println("메인 메뉴로 돌아갑니다.");
                    return;
                default:
    ...
    public void subWhileMenu() {
        ...
        do {
            ...
            System.out.println(". 문자 하나 입력받아, 그 문자의 유니코드 출력 반복('0' 입력되면 반복종료)\n" +
